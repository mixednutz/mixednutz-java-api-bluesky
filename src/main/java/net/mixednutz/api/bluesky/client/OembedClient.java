...
public class OembedClient {
	...
	private String baseurl = "https://tfemily.com/oembed?url=";
	
	private final RestOperations rest;
		
	public OembedClient(RestOperations rest) {
		super();
		this.rest = rest;
	}

	Oembed lookupOembed(String url) {
		return rest.getForEntity(baseurl+url, Oembed.class).getBody();
	}
